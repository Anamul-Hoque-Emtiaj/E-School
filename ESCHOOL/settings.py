...
SECRET_KEY = 'django-insecure-qw189g!tmxj=**c2$gh355@3q#b!nk9st8i4no%%ku%azc@o2v'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'ESCHOOL','templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS=[
     os.path.join(BASE_DIR, 'ESCHOOL/static/')
]
